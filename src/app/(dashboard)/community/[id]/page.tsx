  ...
  return (
    <div className="max-w-3xl mx-auto">
      ...
      <article className="bg-white rounded-lg border border-gray-200 overflow-hidden">
        {/* Media (project posts only — questions have none) */}
        {!isQuestion && (
        ...
        <div className="p-6">
          {isQuestion && (
            <span className="inline-flex items-center gap-1 text-xs font-semibold text-asu-blue bg-asu-blue/10 px-2 py-0.5 rounded mb-2">
              <svg
                className="w-3 h-3"
                fill="none"
                stroke="currentColor"
